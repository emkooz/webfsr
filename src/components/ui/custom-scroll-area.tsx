...
const CustomScrollArea = forwardRef<HTMLDivElement, CustomScrollAreaProps>(({ children, className = "", ...props }, ref) => {
	...
	const scrollbarHeight =
		scrollInfo.scrollHeight > 0 ? Math.max(20, (scrollInfo.clientHeight / scrollInfo.scrollHeight) * scrollInfo.clientHeight) : 0;

	const scrollbarTop =
		scrollInfo.scrollHeight > 0
			? (scrollInfo.scrollTop / (scrollInfo.scrollHeight - scrollInfo.clientHeight)) * (scrollInfo.clientHeight - scrollbarHeight)
			: 0;
